 ...
 * Extension interface for RoleMenuEntityRepository customizations.
 *
 * RULES:
 *
 ...
 * {@link RoleMenuEntityRepository } beyond what Spring Data JDBC provides by default.
 *
 * HOW IT WORKS:
 * - The base {@link RoleMenuEntityRepository } is automatically generated during wire
 ...
 * methods to the final {@link RoleMenuEntityRepository } implementation.
 *
 * IMPORTANT RULES:
 ...
 *  - The parent {@link RoleMenuEntityRepository }
 ...
 *
 * @see RoleMenuEntityRepository
 * @see com.apihug.rad.domain.role.RoleMenuEntity
 */
@Template(type = Template.Type.TRAIT, usage = "RoleMenu repository extension")
interface _RoleMenuEntityRepository extends RoleMenuEntityRepository {
