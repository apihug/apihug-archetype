...
import com.apihug.rad.domain.organization.repository.OrganizationEntityRepository;

/**
 * !!! FORBIDDEN REMOVE THIS CLASS LEVEL DOCUMENT, THIS IS GOLDEN RULE!!!
 * Extension interface for OrganizationEntityRepository customizations.
 *
 * RULES:
 *
 ...
 * {@link OrganizationEntityRepository } beyond what Spring Data JDBC provides by default.
 *
 * HOW IT WORKS:
 * - The base {@link OrganizationEntityRepository } is automatically generated during wire
 ...
 * methods to the final {@link OrganizationEntityRepository } implementation.
 *
 * IMPORTANT RULES:
 ...
 *  - The parent {@link OrganizationEntityRepository }
 ...
 *
 * @see OrganizationEntityRepository
 * @see com.apihug.rad.domain.organization.OrganizationEntity
 */
interface _OrganizationEntityRepository extends OrganizationEntityRepository {
}
