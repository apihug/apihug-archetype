 ...
 *
 * <p>Service layer implementation for tenant member management. Orchestrates Customer,
 * TenantMember, and Tenant domain operations.
 */
@Service
...
public class TenantMemberServiceImpl implements TenantMemberService {
   ...
   *
   * <ul>
   *   <li>Authorities: [TENANT_MEMBER_VIEW]
   * </ul>
   *
   * @apiNote
   ...
   *
   * <ul>
   *   <li>Authorities: [TENANT_MEMBER_ADD]
   * </ul>
   *
   * @apiNote
   *     <p>{@code /api/tenant-members/tenants/{tenantId}/members}
  ...
  public void addMemberToTenant(
    ...
    if (tenantMemberRepository.existsByCustomerIdAndTenantId(customerId, tid)) {
      throw HopeErrorDetailException.errorBuilder(TenantMemberErrorEnum.MEMBER_ALREADY_EXISTS)
          .build();
    }
   ...
   *
   * <ul>
   *   <li>Authorities: [TENANT_MEMBER_REMOVE]
   * </ul>
   *
   * @apiNote
   ...
   *
   * <ul>
   *   <li>Authorities: [TENANT_MEMBER_LOCK]
   * </ul>
   *
   * @apiNote
   ...
   *
   * <ul>
   *   <li>Authorities: [TENANT_MEMBER_ASSIGN_ROLE]
   * </ul>
   *
   * @apiNote
  ...
  public void getMemberDetail(
      SimpleResultBuilder<TenantMemberDetail> builder, Integer tenantId, Integer memberId) {
    // 1. 查找成员关系
    TenantMemberEntity member =
        tenantMemberRepository
            .findById(memberId.longValue())
    ...
    tenantRepository
        ...
        .ifPresent(t -> detail.setTenantName(t.getTenantName()).setTenantCode(t.getTenantCode()));
  ...
  public void getMemberRoles(
    ...
    MemberRoleSummary summary =
        new MemberRoleSummary().setMemberId(member.getId()).setRoles(roleItems);
