...
@Template(
    ...
    usage = "Customer account management service (platform-level)",
    percentage = 90)
@Service
...
public class CustomerManagementServiceImpl implements CustomerManagementService {
  ...
  public void createCustomer(
    ...
    if (customerRepository.existsByUsername(createCustomerRequest.getUsername())) {
      throw HopeErrorDetailException.errorBuilder(CustomerErrorEnum.CUSTOMER_ALREADY_EXISTS)
          .build();
    }
    ...
    CustomerEntity entity =
        new CustomerEntity()
            ...
            .setDefaultTenantId(
                createCustomerRequest.getDefaultTenantId() != null
