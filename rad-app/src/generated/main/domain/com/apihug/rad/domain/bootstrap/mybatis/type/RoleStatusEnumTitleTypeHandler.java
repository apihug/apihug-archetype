...
public class RoleStatusEnumTitleTypeHandler implements TypeHandler<RoleStatusEnum> {
  public static final ParameterTypeConverter<RoleStatusEnum, String> PTC = source -> source != null ? source.title() : null;

  @Override
  public void setParameter(PreparedStatement ps, int idx, RoleStatusEnum parameter,
  ...
  public RoleStatusEnum getResult(ResultSet rs, String columnName) throws SQLException {
    ...
    return RoleStatusEnum.NA.mapFromName(name);
  }
