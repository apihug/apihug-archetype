...
public class RadLiquibaseConfiguration extends AbstractLiquibaseConfiguration {
  ...
  public RadLiquibaseConfiguration(Environment env) {
    super(env);
  }
  ...
  public SpringLiquibase springLiquibase() {
    ...
    final Customizer customizer =
            (liquibase, domain) -> {
              ...
              liquibase.setChangeLog("classpath:liquibase/rad/master.xml");
            };
