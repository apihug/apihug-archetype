...
@Table(
    ...
    indexes = {
        ...
        @Index(name = "IDX_SYS_DEPARTMENT_TENANT_ID", columnList = "TENANT_ID")
    },
    uniqueConstraints = @UniqueConstraint(name = "UK_SYS_DEPARTMENT_TENANT_ID_DEPT_CODE", columnNames = {"TENANT_ID", "DEPT_CODE"})
)
