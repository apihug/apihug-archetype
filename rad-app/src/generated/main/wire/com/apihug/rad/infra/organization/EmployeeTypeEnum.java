...
public enum EmployeeTypeEnum implements Enumeration<EmployeeTypeEnum> {
  ...
  public static final List<EmployeeTypeEnum> ENUMS;

  public static final List<Integer> CODES;

  public static final Map<String, EmployeeTypeEnum> NAME_2_ENUM_MAP;

  public static final Map<Integer, EmployeeTypeEnum> CODE_2_ENUM_MAP;

  public static final Enumeration.EnumerationsHelper<EmployeeTypeEnum> HELPER;

  static {
    List<String> _VALUES = new ArrayList<>();
    List<EmployeeTypeEnum> _ENUMS = new ArrayList<>();
    List<Integer> _CODES = new ArrayList<>();
    Map<String, EmployeeTypeEnum> _NAME_2_ENUM_MAP = new LinkedHashMap<>();
    Map<Integer, EmployeeTypeEnum> _CODE_2_ENUM_MAP = new LinkedHashMap<>();
    for (EmployeeTypeEnum each : EmployeeTypeEnum.values()) {
    ...
    HELPER =
    new EnumerationsHelper<EmployeeTypeEnum>() {

    @Override
    public EmployeeTypeEnum mapFromCode(int code) {
    	return CODE_2_ENUM_MAP.getOrDefault(code, NA);
    }

    @Override
    public EmployeeTypeEnum mapFromName(String name) {
    ...
    @Override
    public Class<EmployeeTypeEnum> supportClz() {
    	return EmployeeTypeEnum.class;
    }
    ...
    @Override
    public List<EmployeeTypeEnum> supportEnumerations() {
    return ENUMS;
    }
  ...
  EmployeeTypeEnum(int code, String description, String description2, boolean deprecated) {
    this.code = code;
  ...
  EmployeeTypeEnum(int code, String description, String description2) {
